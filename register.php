                        ...
                        <div class="book_room">
                            ...
                            <form class="book_now">
                                <div class="row">
                                    <div class="col-md-12">
                                        <span>Username</span>
                                        <input class="online_book" type="text" name="username" id="username">
                                    </div>
                                    <div class="col-md-12">
                                        <span>Password</span>
                                        <input class="online_book" type="password" name="password" id="password">
                                    </div>
                                    <div class="col-md-12">
                                        <span>Address</span>
                                        <input class="online_book" type="text" name="address" id="address">
                                    </div>
                                    <div class="col-md-12">
                                        <span>Phone Number</span>
                                        <input class="online_book" type="text" name="phoneno" id="phoneno">
                                    </div>
                                    <div class="col-md-12">
                                        <button class="book_btn" id="registerButton">Register Now</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response === 'success') {
                            ...
                            alert(response); // Handle error or other response scenarios
                        }
                    }
                });
            });
